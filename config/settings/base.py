...
MIGRATION_MODULES = {"sites": "gearcore.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "gearcore.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "gearcore.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "GearCore API",
    "DESCRIPTION": "Documentation of API endpoints of GearCore",
    "VERSION": "1.0.0",
